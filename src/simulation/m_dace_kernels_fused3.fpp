...
! M4 (WENO3): compiled only when CMake links the buff=3 WENO3 kernel family.
#if defined(MFC_DACE)
module m_dace_kernels_fused3
  ...
  use m_constants, only: model_eqns_5eq, avg_state_arithmetic, &
                        wave_speeds_direct
  use openacc, only: acc_wait_all
  implicit none
  private
  public :: s_dace_fused3_x, dace_fused3_dirs, dace_fused3_contract
...
#define MFC_DACE_BAKED_BUFF 2
  ...
  interface
    subroutine fused3_run_x(state, &
          ...
          & vsrc_d1, &
          & vsrc_d2) &
        bind(C, name='__program_mfc_dace_fused3_x')
      ...
      type(c_ptr), value :: d_cbl_x
      type(c_ptr), value :: d_cbr_x
      ...
      type(c_ptr), value :: poly_coef_cbl_x
      type(c_ptr), value :: poly_coef_cbr_x
      ...
      integer(c_int64_t), value :: beta_coef_x_d0
      integer(c_int64_t), value :: beta_coef_x_d1
      integer(c_int64_t), value :: d_cbl_x_d0
      integer(c_int64_t), value :: d_cbr_x_d0
      ...
      integer(c_int64_t), value :: poly_coef_cbl_x_d0
      integer(c_int64_t), value :: poly_coef_cbl_x_d1
      integer(c_int64_t), value :: poly_coef_cbr_x_d0
      integer(c_int64_t), value :: poly_coef_cbr_x_d1
      ...
      integer(c_int64_t), value :: v_rs_d0
      integer(c_int64_t), value :: v_rs_d1
      integer(c_int64_t), value :: v_rs_d2
      integer(c_int64_t), value :: vsrc_d0
      integer(c_int64_t), value :: vsrc_d1
      integer(c_int64_t), value :: vsrc_d2
    end subroutine

    function fused3_init_x(&
          & beta_coef_x_d0, &
          & beta_coef_x_d1, &
          & d_cbl_x_d0, &
          & d_cbr_x_d0, &
          ...
          & vsrc_d1, &
          & vsrc_d2) &
        bind(C, name='__dace_init_mfc_dace_fused3_x')
      import :: c_ptr, c_int, c_int64_t, c_double
      type(c_ptr) :: fused3_init_x
      integer(c_int64_t), value :: beta_coef_x_d0
      integer(c_int64_t), value :: beta_coef_x_d1
      integer(c_int64_t), value :: d_cbl_x_d0
      integer(c_int64_t), value :: d_cbr_x_d0
    ...
    function fused3_exit_x(state) bind(C, name='__dace_exit_mfc_dace_fused3_x')
      import :: c_ptr, c_int
      integer(c_int) :: fused3_exit_x
      type(c_ptr), value :: state
    end function
  end interface
  interface
    subroutine fused3_run_y(state, &
          & accel_bf, &
          & acoustic_source, &
          & adap_dt, &
          & adap_dt_max_iters, &
          ...
          & vsrc_d1, &
          & vsrc_d2) &
        bind(C, name='__program_mfc_dace_fused3_y')
      import :: c_ptr, c_int, c_int64_t, c_double
      type(c_ptr), value :: state
      type(c_ptr), value :: accel_bf
      type(c_ptr), value :: acoustic_source
      ...
      type(c_ptr), value :: cvs
      type(c_ptr), value :: cyl_coord
      type(c_ptr), value :: d_cbl_y
      type(c_ptr), value :: d_cbr_y
      type(c_ptr), value :: dir_flg
      type(c_ptr), value :: dir_idx
      type(c_ptr), value :: dir_idx_tau
      type(c_ptr), value :: down_sample
      ...
      type(c_ptr), value :: pi_inf_sf
      type(c_ptr), value :: pi_infs
      type(c_ptr), value :: poly_coef_cbl_y
      type(c_ptr), value :: poly_coef_cbr_y
      type(c_ptr), value :: poly_sigma
      type(c_ptr), value :: polydisperse
      type(c_ptr), value :: polytropic
      type(c_ptr), value :: precision
      ...
      type(c_ptr), value :: z_cb
      type(c_ptr), value :: z_cc
      integer(c_int64_t), value :: beta_coef_y_d0
      integer(c_int64_t), value :: beta_coef_y_d1
      integer(c_int64_t), value :: d_cbl_y_d0
      integer(c_int64_t), value :: d_cbr_y_d0
      integer(c_int64_t), value :: flux_d0
      integer(c_int64_t), value :: flux_d1
      integer(c_int64_t), value :: flux_d2
      integer(c_int64_t), value :: fsrc_d0
      ...
      integer(c_int64_t), value :: offset_re_idx_d0
      integer(c_int64_t), value :: offset_re_idx_d1
      integer(c_int64_t), value :: poly_coef_cbl_y_d0
      integer(c_int64_t), value :: poly_coef_cbl_y_d1
      integer(c_int64_t), value :: poly_coef_cbr_y_d0
      integer(c_int64_t), value :: poly_coef_cbr_y_d1
      integer(c_int64_t), value :: re_d0
      integer(c_int64_t), value :: re_d1
      integer(c_int64_t), value :: re_d2
      integer(c_int64_t), value :: re_idx_d0
    ...
    function fused3_init_y(&
          ...
          & vsrc_d1, &
          & vsrc_d2) &
        bind(C, name='__dace_init_mfc_dace_fused3_y')
      import :: c_ptr, c_int, c_int64_t, c_double
      type(c_ptr) :: fused3_init_y
      integer(c_int64_t), value :: beta_coef_y_d0
      integer(c_int64_t), value :: beta_coef_y_d1
      integer(c_int64_t), value :: d_cbl_y_d0
      integer(c_int64_t), value :: d_cbr_y_d0
    ...
    function fused3_exit_y(state) bind(C, name='__dace_exit_mfc_dace_fused3_y')
      import :: c_ptr, c_int
      integer(c_int) :: fused3_exit_y
      type(c_ptr), value :: state
    end function
  end interface
  interface
    subroutine fused3_run_z(state, &
          & accel_bf, &
          & acoustic_source, &
          & adap_dt, &
          & adap_dt_max_iters, &
          ...
          & vsrc_d1, &
          & vsrc_d2) &
        bind(C, name='__program_mfc_dace_fused3_z')
      import :: c_ptr, c_int, c_int64_t, c_double
      type(c_ptr), value :: state
      type(c_ptr), value :: accel_bf
      type(c_ptr), value :: acoustic_source
      ...
      type(c_ptr), value :: cvs
      type(c_ptr), value :: cyl_coord
      type(c_ptr), value :: d_cbl_z
      type(c_ptr), value :: d_cbr_z
      type(c_ptr), value :: dir_flg
      type(c_ptr), value :: dir_idx
      type(c_ptr), value :: dir_idx_tau
      type(c_ptr), value :: down_sample
      ...
      type(c_ptr), value :: pi_inf_sf
      type(c_ptr), value :: pi_infs
      type(c_ptr), value :: poly_coef_cbl_z
      type(c_ptr), value :: poly_coef_cbr_z
      type(c_ptr), value :: poly_sigma
      type(c_ptr), value :: polydisperse
      type(c_ptr), value :: polytropic
      type(c_ptr), value :: precision
      ...
      type(c_ptr), value :: z_cb
      type(c_ptr), value :: z_cc
      integer(c_int64_t), value :: beta_coef_z_d0
      integer(c_int64_t), value :: beta_coef_z_d1
      integer(c_int64_t), value :: d_cbl_z_d0
      integer(c_int64_t), value :: d_cbr_z_d0
      integer(c_int64_t), value :: flux_d0
      integer(c_int64_t), value :: flux_d1
      integer(c_int64_t), value :: flux_d2
      integer(c_int64_t), value :: fsrc_d0
      ...
      integer(c_int64_t), value :: offset_re_idx_d0
      integer(c_int64_t), value :: offset_re_idx_d1
      integer(c_int64_t), value :: poly_coef_cbl_z_d0
      integer(c_int64_t), value :: poly_coef_cbl_z_d1
      integer(c_int64_t), value :: poly_coef_cbr_z_d0
      integer(c_int64_t), value :: poly_coef_cbr_z_d1
      integer(c_int64_t), value :: re_d0
      integer(c_int64_t), value :: re_d1
      integer(c_int64_t), value :: re_d2
      integer(c_int64_t), value :: re_idx_d0
    ...
    function fused3_init_z(&
          ...
          & vsrc_d1, &
          & vsrc_d2) &
        bind(C, name='__dace_init_mfc_dace_fused3_z')
      import :: c_ptr, c_int, c_int64_t, c_double
      type(c_ptr) :: fused3_init_z
      integer(c_int64_t), value :: beta_coef_z_d0
      integer(c_int64_t), value :: beta_coef_z_d1
      integer(c_int64_t), value :: d_cbl_z_d0
      integer(c_int64_t), value :: d_cbr_z_d0
    ...
    function fused3_exit_z(state) bind(C, name='__dace_exit_mfc_dace_fused3_z')
      import :: c_ptr, c_int
      integer(c_int) :: fused3_exit_z
      type(c_ptr), value :: state
    end function
  end interface
...
contains
  ...
  function dace_fused3_dirs(nd) result(c)
    ...
    if (.not. cached) then
      ...
      call get_environment_variable('MFC_DACE_FUSED_DIRS', env, status=st)
      if (st == 0 .and. len_trim(env) >= 1) then
        cached_val(1) = cached_val(1) .and. env(1:1) == '1'
        cached_val(2) = cached_val(2) .and. &
                        (len_trim(env) < 2 .or. env(2:2) == '1')
        cached_val(3) = cached_val(3) .and. &
                        (len_trim(env) < 3 .or. env(3:3) == '1')
      end if
      cached = .true.
    end if
    c = cached_val(nd)
  end function dace_fused3_dirs

  !> The fused bake's case contract.  Both dispatch sites check it -- m_weno
  !! before it skips the reconstruction, m_riemann_solver_hllc before it calls
  !! the kernel -- and m_weno publishes its verdict on top of it, so the two can
  !! never disagree (a skipped reconstruction whose fused call did not happen
  !! would leave the Riemann states stale).  Every clause here is a case flag the
  !! composed kernel folded at build time.
  function dace_fused3_contract() result(c)
    logical :: c
    c = (model_eqns == model_eqns_5eq .and. num_fluids == 2 .and. num_dims == 3 .and. &
         & recon_type == recon_type_weno .and. &
         & wave_speeds == wave_speeds_direct .and. avg_state == avg_state_arithmetic .and. &
         & weno_order == 3 .and. weno_num_stencils == 1 .and. &
         & mapped_weno .and. .not. wenoz .and. .not. teno .and. .not. mp_weno .and. &
         & .not. weno_avg .and. .not. null_weights .and. .not. alt_soundspeed .and. &
         & .not. viscous .and. .not. weno_Re_flux .and. .not. surface_tension .and. &
         & .not. chemistry .and. .not. hypoelasticity .and. .not. mpp_lim .and. &
         & .not. cyl_coord .and. .not. bubbles_euler .and. .not. qbmm .and. &
         & .not. hyper_cleaning .and. .not. relativity .and. &
         & low_Mach == 0 .and. igr == 0 .and. &
         & .not. mixture_err .and. .not. cont_damage .and. &
         & buff_size == BAKED_BUFF_SIZE)
  end function dace_fused3_contract
  ...
  subroutine s_dace_fused3_x(v_rs, pcL, pcR, dL, dR, bcX, flux_rsx, fsrc_rsx, vsrc_rsx, &
    ...
    ! ---- FUSED (M1): the reconstruction inputs, in the WENO dispatch's own
    ! convention: assumed-shape dummies over MFC's full buffers, addressed
    ! through acc_deviceptr_ of their FIRST element, so the kernel's 0-based
    ! dummy position p is MFC's true index p - lbound.  No QL/QR staging
    ! exists on this path -- the reconstructed states never leave registers.
    ...
    integer :: d0pc, d1pc, d0d
    type(c_ptr) :: vrs_dev, pcl_dev, pcr_dev, dl_dev, dr_dev
    logical, save :: fused_announced = .false.
    real(wp), dimension(:, :, :), intent(in), target :: bcX
    type(c_ptr) :: bc_dev
    ...
    type(c_ptr), save :: state_fused3(3) = [c_null_ptr, c_null_ptr, c_null_ptr]
    integer, save :: state_ext_fused3(3) = [-1, -1, -1]
    ...
    ! ---- the reconstruction inputs, resolved exactly as the WENO dispatch
    ! resolves them (m_dace_kernels_weno: c_loc of each buffer's first
    ! element, so the kernel sees the true -buff / -4 based arrays as
    ! 0-based).  These dummies are all `intent(in)`: the fused kernel reads
    ! the primitive buffer and the coefficient tables in place.
    ...
    ! the coefficient tables' own extents, exactly as the WENO dispatch sizes them: the kernel's
    ! table strides come from these, and leaving them to the stack silently misindexes every
    ! reconstructed value (the values stay plausible, so only a bit-exact gate sees it).
    d0pc = size(pcL, 1)
    d1pc = size(pcL, 2)
    d0d = size(dL, 1)
    ! .true.-BEGIN
    if (.true.) then
      ! WENO3's smoothness table; WENO5 computes its betas analytically and has no such dummy.
      bc_dev = acc_deviceptr_(c_loc(bcX(lbound(bcX, 1), lbound(bcX, 2), lbound(bcX, 3))))
      if (.not. c_associated(bc_dev)) then
        print *, 'm_dace_kernels_fused3: beta_coef table not device-present'
        error stop 1
      end if
    end if
    ! .true.-END
    if (.not. c_associated(vrs_dev) .or. .not. c_associated(pcl_dev) .or. &
        & .not. c_associated(pcr_dev) .or. .not. c_associated(dl_dev) .or. &
        & .not. c_associated(dr_dev)) then
      print *, 'm_dace_kernels_fused: reconstruction input not device-present'
      error stop 1
    end if
    if (size(v_rs, 1) /= ext .or. size(v_rs, 2) /= ext .or. &
        & size(v_rs, 3) /= ext) then
      print *, 'm_dace_kernels_fused: v_rs extent', size(v_rs, 1), &
               ' vs the rsx extent', ext
      error stop 1
    end if
    ! DACE<->ACC BOUNDARY SYNC: v_rs_weno and the tables are written on the acc stream
    ! (s_pack_weno_input_arr, the WENO coefficient setup) and read by the DaCe kernel on its
    ! own stream -- the same entry-sync the sweeps dispatch takes from the end of its pack.
    call acc_wait_all()
    ! one line per run: a gate run's log then says which dispatch produced it (a stack of
    ! bit-identical comparisons cannot tell the fused path from the two-kernel one)
    if (.not. fused_announced) then
      print *, 'm_dace_kernels_fused3: FUSED sweep dispatch active (x,y,z)=', &
               dace_fused3_dirs(1), dace_fused3_dirs(2), dace_fused3_dirs(3)
      fused_announced = .true.
    end if
    ...
    if (state_ext_fused3(dir_in) /= ext) then
      if (c_associated(state_fused3(dir_in))) then
        select case (dir_in)
        case (2)
          ierr = fused3_exit_y(state_fused3(2))
        case (3)
          ierr = fused3_exit_z(state_fused3(3))
        case default
          ierr = fused3_exit_x(state_fused3(1))
        end select
      end if
      select case (dir_in)
      case (2)
      state_fused3(2) = fused3_init_y(&
          & int(d0pc, c_int64_t), int(d1pc, c_int64_t), int(d0d, c_int64_t), int(d0d, c_int64_t), nv64, e64, &
          & e64, nv64, e64, e64, int(jd(1), c_int), int(jd(2), c_int), &
          & int(jd(3), c_int), int(jd(4), c_int), int(jd(5), c_int), int(jd(6), c_int), 1_c_int64_t, 1_c_int64_t, &
          & 1_c_int64_t, 1_c_int64_t, 1_c_int64_t, int(d0pc, c_int64_t), int(d1pc, c_int64_t), int(d0pc, c_int64_t), &
          & int(d1pc, c_int64_t), re_e64, re_e64, re_e64, 2_c_int64_t, 2_c_int64_t, &
          & int(rsz1, c_int), int(rsz2, c_int), e64, e64, e64, int(nvels_l, c_int64_t), &
          & e64, e64)
      case (3)
      state_fused3(3) = fused3_init_z(&
          & int(d0pc, c_int64_t), int(d1pc, c_int64_t), int(d0d, c_int64_t), int(d0d, c_int64_t), nv64, e64, &
          & e64, nv64, e64, e64, int(jd(1), c_int), int(jd(2), c_int), &
          & int(jd(3), c_int), int(jd(4), c_int), int(jd(5), c_int), int(jd(6), c_int), 1_c_int64_t, 1_c_int64_t, &
          & 1_c_int64_t, 1_c_int64_t, 1_c_int64_t, int(d0pc, c_int64_t), int(d1pc, c_int64_t), int(d0pc, c_int64_t), &
      ...
      state_ext_fused3(dir_in) = ext
    end if

    select case (dir_in)
    case (2)
      call fused3_run_y(state_fused3(2), &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, bc_dev, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, d_zeros, d_zeros, dl_dev, dr_dev, &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_flux, d_fsrc, &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, d_gammas, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          ...
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_pi_infs, pcl_dev, pcr_dev, d_zeros, d_zeros, &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, re_dev, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_qvs, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, ridx_dev, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, rgs_dev, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          ...
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          & vrs_dev, d_zeros, d_zeros, d_vsrc, d_zeros, d_zeros, &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, d_zeros, d_zeros, int(d0pc, c_int64_t), int(d1pc, c_int64_t), &
          & int(d0d, c_int64_t), int(d0d, c_int64_t), nv64, e64, e64, nv64, &
          & e64, e64, int(jd(1), c_int), int(jd(2), c_int), int(jd(3), c_int), int(jd(4), c_int), &
          & int(jd(5), c_int), int(jd(6), c_int), 1_c_int64_t, 1_c_int64_t, 1_c_int64_t, 1_c_int64_t, &
          & 1_c_int64_t, int(d0pc, c_int64_t), int(d1pc, c_int64_t), int(d0pc, c_int64_t), int(d1pc, c_int64_t), re_e64, &
          & re_e64, re_e64, 2_c_int64_t, 2_c_int64_t, int(rsz1, c_int), int(rsz2, c_int), &
          & e64, e64, e64, int(nvels_l, c_int64_t), e64, e64)
    case (3)
      call fused3_run_z(state_fused3(3), &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, bc_dev, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          ...
          & e64, e64, e64, int(nvels_l, c_int64_t), e64, e64)
    case default
      call fused3_run_x(state_fused3(1), &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, bc_dev, d_zeros, d_zeros, d_zeros, &
          & d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, d_zeros, &
  ...
  end subroutine s_dace_fused3_x
...
end module m_dace_kernels_fused3
#endif
#endif
